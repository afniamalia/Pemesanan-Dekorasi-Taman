...
public class MainActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            paket = getResources().getStringArray(R.array.paket);

            ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,paket);
            ...
            btnPesan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (strTanggal.matches("Tanggal")||strWaktu.matches("Waktu")){
                        ...
                        pesan.putExtra("paket", paket[index]);
